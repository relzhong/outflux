...
func (p *pipeService) createTransformers(pipeID string, infConn influx.Client, measure string, inputDb string, conf *MigrationConfig) ([]transformation.Transformer, error) {
	return createTransformers(p.transformerService, pipeID, infConn, measure, inputDb, conf)
}

func createTransformers(transformerService TransformerService, pipeID string, infConn influx.Client, measure string, inputDb string, conf *MigrationConfig) ([]transformation.Transformer, error) {
